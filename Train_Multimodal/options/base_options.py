...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self._parser.add_argument('--VAD_criterion', type=str, default= 'kld')
        ...
        self._parser.add_argument('--lambda_VAD', type=float, default=1)
        ########## Data and tasks #########
        ...
        self._parser.add_argument('--seq_len', type=int, default= 8, help='length of input seq ')
