...
class _Miscalibration(object):
    ...
    def measure(self, X: np.ndarray, y: np.ndarray, metric: str, return_map: bool = False,
                 return_num_samples: bool = False,
                 return_bins: bool = False) -> Union[float, tuple]:
        """
        ...
        if return_map or return_num_samples or return_bins:
            ...
            if return_bins:
                return_value = return_value + (acc_hist, conf_hist)
            return return_value
        else:
