...
class Multitask_DatasetDataLoader:
    def __init__(self, train_mode, num_threads, dataset_names,
        tasks, batch_size, seq_len, fps, transform=None):
    ...
    def _create_datasets(self):
        ...
        for i, dataset_name in enumerate(self.dataset_names):
            task = self.tasks[i]
            self.datasets[task] = DatasetFactory.get_by_name(dataset_name, self.seq_len, self.fps, self.train_mode, self.transform)
