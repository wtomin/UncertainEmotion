...
parser.add_argument('--au_txt', type=str, default = 'test_set_AU_Challenge.txt')
parser.add_argument('--expr_txt', type=str, default = 'test_set_Expr_Challenge.txt')
parser.add_argument('--va_txt', type=str, default = 'test_set_VA_Challenge.txt')
...
def refine_frames_paths(frames, length):
	...
	if len(frames) == length:
		...
		raise ValueError("Number of frames larger than the cv2 video lenth")
def main():
